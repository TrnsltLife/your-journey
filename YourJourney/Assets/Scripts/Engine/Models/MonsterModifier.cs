...
public class MonsterModifier
{
    ...
    private void AssignCostsFromBonuses()
    {
        /*
        Initial Cost:
        1 point per type:

        Initial Cost and Additional Cost:
        health: 1
        armor: 3
        sorcery: 6
        damage: 2
        ...
        */
        ...
        if (cost > 0 && additionalCost > 0) { return; }

        int typeCost = 0;
        int unitCost = 0;
        if(health != 0) { typeCost += 1; unitCost += health * 1; }
        if(armor != 0) { typeCost += 1; unitCost += armor * 3; }
        if(sorcery != 0) { typeCost += 1; unitCost += sorcery * 6; }
        if(damage != 0) { typeCost += 1; unitCost += damage * 2; }
        if(fear != 0) { typeCost += 1; unitCost += fear * 2; }
        if(immuneCleave) { unitCost += 4; }
        if(immuneLethal) { unitCost += 3; }
        if(immunePierce) { unitCost += 3; }
        if(immuneSmite) { unitCost += 5; }
        if(immuneStun) { unitCost += 5; }
        if(immuneSunder) { unitCost += 3; }

        if(typeCost < 0) { typeCost = 0; }
        if(unitCost < 0) { unitCost = 0; }

        cost = typeCost + unitCost;
        additionalCost = unitCost;
    }
    ...
    public static readonly MonsterModifier ELDEST_WORM_1 = new MonsterModifier(16, "Eldest Worm", MonsterModifierGroup.Extended) { health = -4, armor = 1, immunePierce = true, immuneSunder = true }.Add(MonsterType.FoulBeast).Add(MonsterType.AnonymousThing).Add(MonsterType.LichKing).AddToList();
    public static readonly MonsterModifier ELDEST_WORM_2 = new MonsterModifier(17, "Eldest Worm", MonsterModifierGroup.Extended) { armor = 1, immunePierce = true, immuneSunder = true }.Add(MonsterType.FoulBeast).Add(MonsterType.AnonymousThing).Add(MonsterType.LichKing).AddToList();
    public static readonly MonsterModifier ELDEST_WORM_3 = new MonsterModifier(18, "Eldest Worm", MonsterModifierGroup.Extended) { health = 4, armor = 1, immunePierce = true, immuneSunder = true }.Add(MonsterType.FoulBeast).Add(MonsterType.AnonymousThing).Add(MonsterType.LichKing).AddToList();
    ...
    public static readonly MonsterModifier PACKS_VENGEANCE_2 = new MonsterModifier(28, "Pack's Vengeance", MonsterModifierGroup.Extended) { health = 2, immuneStun = true, fakeLethal = true }.AddVargs().AddToList();
    ...
    public static readonly MonsterModifier DWARVEN_BANE_1 = new MonsterModifier(39, "Dwarven Bane", MonsterModifierGroup.Named) { armor = -2, fear = -1 }.Add(MonsterType.Balerock).AddToList();
    public static readonly MonsterModifier DWARVEN_BANE_2 = new MonsterModifier(40, "Dwarven Bane", MonsterModifierGroup.Named) { armor = 1, immuneLethal = true, immuneStun = true }.Add(MonsterType.Balerock).AddToList();
    public static readonly MonsterModifier DWARVEN_BANE_3 = new MonsterModifier(41, "Dwarven Bane", MonsterModifierGroup.Named) { armor = 1, sorcery = 1, health = 4, fear = 1, immuneLethal = true, immuneSunder = true }.Add(MonsterType.Balerock).AddToList();
    public static readonly MonsterModifier DWARVEN_BANE_4 = new MonsterModifier(42, "Dwarven Bane", MonsterModifierGroup.Named) { armor = 2, sorcery = 2, health = 5, fear = 2, damage = 2, immuneLethal = true, immuneSunder = true, immuneStun = true }.Add(MonsterType.Balerock).AddToList();
    public static readonly MonsterModifier MASTER_OF_THE_PIT_1 = new MonsterModifier(43, "Master of the Pit", MonsterModifierGroup.Named) { sorcery = 1, immuneStun = true }.AddToList();
    public static readonly MonsterModifier MASTER_OF_THE_PIT_2 = new MonsterModifier(44, "Master of the Pit", MonsterModifierGroup.Named) { sorcery = 2, immuneStun = true }.AddToList();
    public static readonly MonsterModifier MASTER_OF_THE_PIT_3 = new MonsterModifier(45, "Master of the Pit", MonsterModifierGroup.Named) { sorcery = 3, immuneStun = true }.AddToList();
