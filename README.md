...
# Your Journey - v0.23 - Windows and Mac
...
[Download the Newest Release!](https://github.com/TrnsltLife/your-journey/releases/tag/v0.23) Featuring tiles from Shadowed Paths, enemies from all the expansions, more character portraits, and UI translations in English and French, and the start of a skinnable enemy system!

([View GlowPuff's original releases](https://github.com/GlowPuff/your-journey/releases))

#### Installation instructions - Windows
1. Unzip the YourJourney_Win_v0.23.zip file somewhere and run "Your Journey.exe".
...
1. Download YourJourney_Mac_v0.22.zip file somewhere and run "YourJourney_v0.23". If it tells you it can't run the software because it can't verify there aren't any viruses, try again and tell it to Open anyways.
